...
class _ProviderListState extends State<ProviderList> {
  ...
  Widget build(BuildContext context) {
    ProviderFilterCubit cubit = context.read<ProviderFilterCubit>();
    return BlocBuilder<ProviderFilterCubit,  ProviderFilterState>(
      builder: (context, state) {
        if (state is ProvidersProviderFilterLoading) {
          return ShowLoadingIndicator();
        } else if (state is ProvidersProviderFilterError) {
